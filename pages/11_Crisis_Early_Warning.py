...
with radar_col:
    ...
    render_section_export(
        base_name=f"TrustIntel_{display_name}_Crisis_Signal_Radar",
        data=pd.DataFrame(
            {
                "Signal": risk_sources,
                "Score": risk_values,
...
if news_df.empty:
    ...
    with lang_left:
        ...
        render_section_export(
            base_name=f"TrustIntel_{display_name}_Crisis_Language_Pressure",
            data=lang_rank,
            figure=lang_fig,
            sheet_name="Language Pressure",
        )
    ...
    with lang_right:
        ...
        render_section_export(
            base_name=f"TrustIntel_{display_name}_Crisis_Language_Scatter",
            data=language_summary,
            figure=scatter,
            sheet_name="Language Risk",
        )
...
if (
    ...
    if not timeline_df.empty:
        ...
        if len(daily) >= 2:
            ...
            render_section_export(
                base_name=f"TrustIntel_{display_name}_Crisis_Narrative_Trajectory",
                data=daily,
                figure=time_fig,
                sheet_name="Narrative Trajectory",
            )
...
if news_df.empty:
    ...
    render_section_export(
        base_name=f"TrustIntel_{display_name}_Crisis_Priority_Evidence",
        data=priority_news[
            [
                column
                for column in display_columns
