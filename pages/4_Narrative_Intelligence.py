...
google_limit = st.sidebar.slider(
    "Google News rows per language",
    min_value=3,
    max_value=12,
    value=6,
    step=1,
...
gdelt_limit = st.sidebar.slider(
    "GDELT maximum records",
    min_value=10,
    max_value=150,
    value=50,
    step=10,
...
brief = (
    f"TrustIntel collected <strong>{len(fusion_df)}</strong> evidence records "
