...
with source_left:
    ...
    render_section_export(
        base_name=f"TrustIntel_{display_name}_Source_Mix",
        data=source_mix,
        figure=source_fig,
        sheet_name="Source Mix",
    )
...
with source_right:
    ...
    render_section_export(
        base_name=f"TrustIntel_{display_name}_Source_Language",
        data=source_language,
        figure=heat_fig,
        sheet_name="Source x Language",
    )
...
render_section_export(
    base_name=f"TrustIntel_{display_name}_Narrative_Clusters",
    data=top_clusters,
    figure=cluster_fig,
    sheet_name="Narrative Clusters",
)
...
render_section_export(
    base_name=f"TrustIntel_{display_name}_Corroboration_Landscape",
    data=clusters_df,
    figure=bubble,
    sheet_name="Corroboration",
)
...
render_section_export(
    base_name=f"TrustIntel_{display_name}_Priority_Cluster_Table",
    data=cluster_display,
    sheet_name="Priority Clusters",
)
...
render_section_export(
    base_name=f"TrustIntel_{display_name}_Evidence_Stream",
    data=evidence_display.drop(
        columns=[
            "Published Parsed",
        ],
        errors="ignore",
    ),
    sheet_name="Evidence Stream",
)
