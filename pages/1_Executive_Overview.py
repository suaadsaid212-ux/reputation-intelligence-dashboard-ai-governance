...
with left:
    ...
    render_section_export(
        base_name="TrustIntel_Executive_Reputation_Ranking",
        data=risk_chart_df,
        figure=bar,
        sheet_name="Reputation Ranking",
    )
...
with right:
    if coverage_df.empty:
        ...
        render_section_export(
            base_name="TrustIntel_Executive_Language_Intelligence",
            data=lang_display,
            figure=lang_fig,
            sheet_name="Language Intelligence",
        )
...
render_section_export(
    base_name="TrustIntel_Executive_Risk_Landscape",
    data=risk_df,
    figure=bubble,
    sheet_name="Risk Landscape",
)
...
if action_df.empty:
    ...
    render_section_export(
        base_name="TrustIntel_Executive_Action_Queue",
        data=action_export_df,
        sheet_name="Action Queue",
    )
...
if negative_rows:
    ...
    render_section_export(
        base_name="TrustIntel_Executive_Top_Risk_Narratives",
        data=evidence_view,
        sheet_name="Top Risk Narratives",
    )
