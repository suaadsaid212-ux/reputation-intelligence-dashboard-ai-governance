...
def render_live_status(
    ...
    *,
    ...
    for label, status in sources:
        ...
        badges.append(
            f"""
            <span class="ti-source-pill">
                <span class="ti-source-name">{label}</span>
                <span
                    class="ti-source-status"
    ...
    st.markdown(
        f"""
        <div class="ti-statusbar">
            <div class="ti-status-left">
                <span class="ti-live-dot"></span>
                <span class="ti-status-title">
                    Intelligence Operations
                </span>
                {"".join(badges)}
            </div>
            <div class="ti-status-time">
                Page refreshed {format_local_time(refreshed_at)}
            </div>
        </div>
        {note_html}
        """,
